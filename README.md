...
## 회사 경력
- Naver 오디오 클립 Android 인턴 : 2019. 04 ~ 2019. 06
- (주) 스마일 이벤트(돌잔치 전문 MC) : 2015. 10 ~ 2017. 10
...
- 역할 : 전체 개발
- 적용 기술 : MVVM, DataBinding, RxJava2, Retrofit2, Room, Glide, PhotoView
...
- 적용 기술 : DataBinding, MVP, Glide, Retrofit2, uCrop, **OverlapLoopView**
...
- 역할 : 전체 개발
- 적용 기술 : ViewHolder, VelocityTracker, ViewPropertyAnimator
...
- 역할 : 전체 개발
- 적용 기술 : MVP, Volley, Glide, Preload
...
- 적용 기술 : Kakao Newtone API, SQLiteDatabase
