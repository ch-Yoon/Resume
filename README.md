...
## 회사 경력
- Naver 오디오클립 Android 인턴 : 2019. 04 ~ 2019. 06
- (주) 스마일이벤트(돌잔치 전문 MC) : 2015. 10 ~ 2017. 10
...
- 2017 서울국제발명전시회 금상 (시각장애인을 위한 점자 학습 앱) : 2017. 12. 02
...
**이미지 검색 토이 프로젝트**
- 기간 : 2019. 08 ~ 현재
- 내용 : Kakao 이미지 검색 API를 활용하는 이미지 검색 토이 프로젝트
- 역할 :  
  - 개인 개발
...
- 사용 언어 : `Kotlin`
- 사용 기술 : `koin` `MVVM` `DataBinding` `RxJava2` `Retrofit2` `Room` `Glide` `Preload` `Unit Test` `Custom View`
- [Github](https://github.com/ch-Yoon/ImageSearch)


**Naver 오디오 클립 Android 인턴**
- 기간 : 2019. 04 ~ 2019. 06 (총 2개월)
- 내용 : 다운로드 작업(취소, 삭제, 다운로드 현황 확인)을 총괄적으로 관리할 수 있는 다운로드 통합 관리 화면 제작
- 역할 :
  - 과제 개인 개발
  - 오디오클립 다운로드 통합 관리 화면 
  - 구현 기능 Unit Test 진행
...
- 기간 : 2019. 01 ~ 2019. 02 (총 1개월)
- 내용 : 음식점 사장님들은 앱에 메뉴를 등록, 손님은 특정 위치 주변에 등록된 메뉴들 중 swipe하며 원하는 메뉴를 선택하는 앱
- 역할 :
  - 3인 팀 개발
  - 프로젝트 기반 구성
  - 로그인 및 회원가입 구현
...
## 대외 활동
**부스트코스 학습 페이스 메이커 : 2019. 07. 19 ~ 2019. 09. 19 (총 2개월)**
- 부스트코스 Android 학습 페이스 메이커 활동 수료
- Slack 및 Github 활용하여 멘토링 

**Naver 오디오 클립 Android 인턴 : 2019. 04. 22 ~ 2019. 06. 21 (총 2개월)**
- Naver 하계 인턴십 진행
- 오디오클립 다운로드 통합 관리 화면 개발
- 오디오클립 다운로드 모듈 Java -> Kotlin 변환
- 멘토링 및 매주 주간 회의 참석하여 회사 문화 경험

**부스트캠프 Android 과정 3기 : 2019. 01. 21 ~ 2019. 02. 22 (총 1개월)**
- Android 현업 기반 실무 협업 교육
...
- 부스트코스 전용 API 활용 영화 리뷰 App 제작
- Android 온라인 강의 수강
- 오프라인 스터디 그룹 참여
- 현업 개발자분들로부터 코드 리뷰를 받으며 총 8단계의 단계별 프로젝트 수행
- 우수 수료생 수료
